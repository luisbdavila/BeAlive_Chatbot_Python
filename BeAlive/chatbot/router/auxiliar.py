...
def add_message(new_item, file_name):
    """Adds a single message to a JSON file, assigning it a unique ID.

    Parameters:
    ----------
    new_item : dict
        The message to add, provided as a dictionary.
    file_name : str
        The name of the JSON file to store the messages.

    Raises:
    ------
    json.JSONDecodeError
        If there is an error decoding the JSON content from the file.
    IOError, OSError
        If there is an issue accessing or writing to the specified file.
    Exception
...
def add_messages(new_items, file_name):
    ...
    Parameters:
    ----------
    new_items : list of dict
        A list of dictionaries representing the messages to add.
    file_name : str
        The name of the JSON file to store the messages.
